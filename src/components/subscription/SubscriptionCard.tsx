  ...
  return (
    <>
      <Card className="bg-gradient-to-br from-gray-900 via-gray-900 to-black border border-white/10 relative overflow-hidden rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
        ...
        <motion.div 
          className="absolute -bottom-32 -left-32 w-64 h-64 bg-blue-600/20 rounded-full blur-3xl" 
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2]
          }} 
            ...
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              <p className="text-gray-300 text-lg leading-relaxed">
                {profile?.is_subscribed 
                  ? "Thank you for being a premium member. Enjoy unlimited access to all features and premium content."
                  : "Start your 3-day free trial today and experience all premium features. Cancel anytime before the trial ends."
                }
              </p>
            </div>
