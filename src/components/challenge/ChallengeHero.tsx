  ...
  return (
    ...
    >
      <div className="relative bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 p-8 md:p-12">
        {/* Enhanced floating elements - optimized for performance */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-blue-500/10 rounded-full filter blur-[80px] will-change-transform" />
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-purple-500/10 rounded-full filter blur-[80px] will-change-transform" />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-500/10 rounded-full filter blur-[100px]" />
        </div>

        {/* Decorative patterns - CSS simplified for better performance */}
        <div className="absolute inset-0 opacity-20 bg-gradient-radial from-indigo-500/10 to-transparent" />
        ...
        {/* Enhanced glow effects - optimized for performance */}
...
ChallengeHero.displayName = 'ChallengeHero';
