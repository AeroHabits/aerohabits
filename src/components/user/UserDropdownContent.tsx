...
export function UserDropdownContent({
  ...
  return <DropdownMenuContent className="w-56 bg-white/95 backdrop-blur-md border border-gray-200 shadow-xl rounded-xl p-1 dark:bg-gray-900/95 dark:border-gray-800" align="end">
      ...
      <DropdownMenuSeparator className="bg-gray-200 dark:bg-gray-800" />
      <DropdownMenuItem className="text-red-600 dark:text-red-400 cursor-pointer flex items-center gap-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md m-1 px-2 py-1.5 transition-colors duration-200" onClick={onSignOut}>
