  ...
  return (
    ...
    >
      ...
      <motion.form 
        ...
        className="space-y-6 bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-lg p-8 md:p-10 rounded-xl shadow-2xl border border-indigo-500/30"
      >
        <div className="flex items-center mb-8 relative">
          ...
          <div className="flex items-center justify-center w-full">
            <motion.div
              ...
              className="p-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg mr-4"
            >
        ...
        <div className="space-y-6 mt-10">
          ...
          >
            ...
            <Input
              ...
              className={cn(
                "pl-12 py-6 text-lg bg-slate-800/80 border-slate-700/80 focus:border-indigo-500/70 text-white placeholder:text-gray-400 rounded-xl transition-all duration-300",
                "hover:border-indigo-400/50 focus:ring-2 focus:ring-indigo-500/30",
                isTitleFocused && "shadow-[0_0_15px_rgba(99,102,241,0.2)]"
              )}
            />
          </motion.div>
          ...
          >
            ...
            <Textarea
              ...
              className={cn(
                "pl-12 bg-slate-800/80 border-slate-700/80 focus:border-indigo-500/70 text-white placeholder:text-gray-400 rounded-xl min-h-[160px]",
                "transition-all duration-300 hover:border-indigo-400/50 focus:ring-2 focus:ring-indigo-500/30",
                isDescriptionFocused && "shadow-[0_0_15px_rgba(99,102,241,0.2)]"
              )}
            />
          </motion.div>
        ...
        <motion.div className="pt-6">
          <div className="relative overflow-hidden rounded-xl">
            ...
            <Button 
              type="submit"
              className="relative w-full bg-transparent text-white font-semibold py-6 text-lg shadow-xl transition-all duration-500 
