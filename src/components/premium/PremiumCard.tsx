      ...
      <CardContent className="space-y-6 pt-6 relative">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          {profile?.is_subscribed 
            ? "Manage your premium features, view billing history, and update payment methods." 
            : "Start your 3-day trial today with card details required. Cancel anytime during trial - no charge."}
        </p>
