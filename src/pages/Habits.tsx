    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-slate-900/50 backdrop-blur-2xl rounded-3xl p-8 md:p-10 shadow-2xl border border-white/[0.05] hover:border-white/[0.08] transition-all duration-300"
        >
          <div className="mb-10 text-center">
            ...
            <h2 className="text-4xl font-bold text-white mb-4 tracking-tight">
              <span className="relative inline-block">
                ...
                <motion.span
                  className="absolute -bottom-1 left-0 w-full h-px bg-gradient-to-r from-blue-200/0 via-blue-200/70 to-blue-200/0"
                  initial={{ width: "0%" }}
                  animate={{ width: "100%" }}
